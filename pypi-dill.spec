...
Version  : 0.4.0
Release  : 37
URL      : https://github.com/uqfoundation/dill/releases/download/0.4.0/dill-0.4.0.tar.gz
Source0  : https://github.com/uqfoundation/dill/releases/download/0.4.0/dill-0.4.0.tar.gz
...
%prep
%setup -q -n dill-0.4.0
cd %{_builddir}/dill-0.4.0
pushd ..
cp -a dill-0.4.0 buildavx2
popd
pushd ..
cp -a dill-0.4.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744813138
