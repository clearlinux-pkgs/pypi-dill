...
Source0  : https://github.com/uqfoundation/dill/releases/download/0.3.8/dill-0.3.8.tar.gz
...
%prep
%setup -q -n dill-0.3.8
cd %{_builddir}/dill-0.3.8
pushd ..
cp -a dill-0.3.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706545156
