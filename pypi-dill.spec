...
%prep
%setup -q -n dill-0.3.5.1
cd %{_builddir}/dill-0.3.5.1
pushd ..
cp -a dill-0.3.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653404810
...
cp %{_builddir}/dill-0.3.5.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-dill/89215dbe96039235796b31ac8e2aa8f659d5c12b
